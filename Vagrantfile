...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder ".", "/home/vagrant/RIOT-Tutorials"
  config.vm.synced_folder "./RIOT", "/home/vagrant/RIOT"
  ...
  config.vm.provision "shell", path: "./RIOT/dist/tools/vagrant/bootstrap.sh"
end
